...
let smartphone = {
    ...
    describe : function (){
     ...
     console.log(chalk.green(`My Smart Phone name is ${chalk.yellow.italic(this.brand)} model ${chalk.yellow.italic
    (this.model)}, others features are my mobile has ${chalk.yellow.italic(this.storage)} storage,\n${chalk.yellow.italic
    (this.screenSize)} Screen size and battery backup is ${chalk.yellow.italic(this.battery)}.`));
  }
};
smartphone.describe()
